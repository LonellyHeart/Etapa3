...
public class TelaCadastroFornecedor extends javax.swing.JFrame {
    ...
    private void brnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_brnCadastrarActionPerformed
            String cnpj = txtCnpj.getText(); // Futuro cadastro em banco de dados
            String contatoForn = txtContatoForn.getText(); // Futuro cadastro em banco de dados
            String enderecoForn = txtEnderecoForn.getText(); // Futuro cadastro em banco de dados
            String informacoesForn = txtInformacoesForn.getText(); // Futuro cadastro em banco de dados
            String razaoSocial = txtRazaoSocial.getText(); // Futuro cadastro em banco de dados
